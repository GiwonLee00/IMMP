...
def bev_settings(input_args=sys.argv[1:]):
    ...
    parser.add_argument('-i', '--input', type=str, default='data/JRDB/jrdb/train_dataset/images/image_0/jordan-hall-2019-04-22_0/000092.jpg', help = 'Path to the input image / video')
    parser.add_argument('-o', '--save_path', type=str, default=osp.join('preprocess_script/romp/files/','BEV_results'), help = 'Path to save the results')
    ...
    parser.add_argument('--smpl_path', type=str, default=osp.join('preprocess_script/romp/files/.romp','SMPLA_NEUTRAL.pth'), help = 'The path of SMPL-A model file')
    parser.add_argument('--smil_path', type=str, default=osp.join('preprocess_script/romp/files/.romp','smil_packed_info.pth'), help = 'The path of SMIL model file')
    parser.add_argument('--model_path', type=str, default=osp.join('preprocess_script/romp/files/.romp',model_dict[model_id]), help = 'The path of BEV checkpoint')
    ...
    # Parsing args
    parser.add_argument('--imgs_dir', type=str, default='data/JRDB/jrdb/train_dataset/images/image_0/', help = 'Path to the input image / video')
    ...
    if args.model_id != 2:
        args.model_path = osp.join('preprocess_script/romp/files/','.romp',model_dict[args.model_id])
